package br.com.safepeople.configs;
...
import br.com.safepeople.services.CustomClienteDetailsService;
import br.com.safepeople.services.CustomFornecedorDetailsService;
import br.com.safepeople.services.UserDetailsServiceImpl;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers("/v1/protected/signin", "/v1/protected/cliente/buscarporuid/{uid}",
						...
						"/v1/protected/cliente/inserir_sessao_carga",
						"/v1/protected/cliente/status_carregamento/atualizar",
